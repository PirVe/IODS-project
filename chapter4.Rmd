...
```
From the cross tabulation presented above we can see that there is a significant amount of misclassification related to lower levels of criminality, but the high crime rate is predicted much more accurately with only single misclassifications. This may be understandable from the point of view that high crime is generally better recognized and subsequently recorded, whereas low crime rates imply fewer observations of crime. 
